...
# Use the session_state ticker instead of a generic 'current_ticker' variable
current_ticker = st.session_state.active_ticker
# Now call the function using the variable quote = fetch_stock_quote(current_ticker)
